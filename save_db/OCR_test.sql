...
--
-- Client :  localhost
-- Généré le :  Lun 04 Septembre 2017 à 12:16
...
--
-- Structure de la table `commentaires_billets`
--

CREATE TABLE IF NOT EXISTS `commentaires_billets` (
`ID` int(11) NOT NULL,
...
--
-- Contenu de la table `commentaires_billets`
--

INSERT INTO `commentaires_billets` (`ID`, `ID_billet`, `auteur`, `commentaire`, `date_commentaire`) VALUES
(1, 1, 'Pedro', 'Un peu court ce billet !', '2010-03-25 16:49:53'),
(2, 1, 'Tintin', 'Ouai, ça commence pas très fort ce blog ...', '2010-03-25 16:57:16'),
(3, 1, 'Jean_Kevin', '+1 !', '2010-03-25 17:12:52');
...
(51, 'Overwatch', 'Peter', 'PC', 10, 1, 'Jeu videal FPS en ligne');
...
(1, 'Sevhalen', 'Salut !', '0000-00-00 00:00:00'),
(2, 'Tintin', 'Hein ??', '0000-00-00 00:00:00');
...
--
-- Index pour la table `commentaires_billets`
--
ALTER TABLE `commentaires_billets`
 ADD PRIMARY KEY (`ID`);
...
--
-- AUTO_INCREMENT pour la table `commentaires_billets`
--
ALTER TABLE `commentaires_billets`
